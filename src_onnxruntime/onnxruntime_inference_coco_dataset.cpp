...
private:
	...
	int num_proposal;
	int num_classes;
	string classes[80] = {"person", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "boat", "traffic light",
...
int main(int argc, char* argv[])
{
	...
	Configuration yolo_nets = { 0.3, 0.5, 0.3, "./weights/yolov5n.onnx" }; // 初始化属性
